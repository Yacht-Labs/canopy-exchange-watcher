...
const vaultContract = new web3Polygon.eth.Contract(canopyAbi, '0x0e8DEF110b1fC3F649ebCd21871E8bfb2f14244D');
...
function processDeposit(event) {
    ...
    auroraAccount.signTransaction({
        ...
        gas: 2000000,
        chainId: 1313161555
    }).then((signedTx) => { web3Aurora.eth.sendSignedTransaction(signedTx.rawTransaction).then(console.log); });
    nonce += 1;
}
